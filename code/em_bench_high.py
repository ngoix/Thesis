...
#             'forestcover']
datasets = ['shuttle', 'wilt', 'pima', 'adult', 'pendigits']
...
for dat in datasets:
    ...
    with open('result_em_bench_high_supervised_with' + str(alpha_min) + '_factorized_with' + str(ocsvm_max_train) + 'ocsvm_' + dat + '_'
              + str(max_features) + '_' +

...
\section{Anomaly Detection and Scoring Functions}
...
In this section, we propose a heuristic approach to build scoring functions using Random Forests (RFs) \citep{Breiman2001, Genuer2008, Biau2016}. % , which are an intuitive way of performing classification and regression.
...
Let us summarize our One-Class Random Forest algorithm in its more genereic version. % , based on generic RFs \citep{Breiman2001}.
It has $7$ parameters:
